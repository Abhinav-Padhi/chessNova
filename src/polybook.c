 ...
 * It reads the book into memory, calculates keys based on the board, and returns randomly selected
 * book moves.
 */
...
/**
 * @brief Checks if there is a capturing pawn available for the active side to perform an en passant
 * capture.
 *
