...
/** @brief Fills the portion of the file starting from and not including the backward most white
 * pawn (i.e the least advanced white pawn) to rank 8
...
/** @brief Fills the portion of the file starting from and not including the forward most black most
 * pawn (i.e the least advanced black pawn) to rank 1
...
/** @brief Fills the portion of the file starting from and not including the backward most white
 * pawn (i.e the least advanced white pawn) to rank 1
 * @param wpawns The white pawns bitboard
...
/** @brief Fills the portion of the file starting from and not including the forward most black pawn
 * (i.e the least advanced black pawn) to rank 8
 * @param bpawns The black pawns bitboard
