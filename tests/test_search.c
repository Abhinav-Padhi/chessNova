...
/**
 * @brief Parses a FEN, executes a search to a given depth, and asserts that the chosen move matches
 * expectations.
 *
 ...
 * and verifies search results. Prints a single success message to stdout on pass, or details to
 * stderr on fail.
 *
