...
void test_pawn_shield_penalties(void) {
    ...
    parse_fen("r1bq1rk1/pppp1ppp/2n2n2/4p3/4P1PP/2N2N2/PPPP1P2/R1BQ1RK1 w - - 0 1",
              &destroyed_shield);
    ...
    parse_fen("r1bq1rk1/pppp1ppp/2n2n2/4p3/4P3/2N2NP1/PPPP1PBP/R1BQ1RK1 w - - 0 1",
              &fianchetto_with_bishop);
    parse_fen("r1bq1rk1/pppp1ppp/2n2n2/4p3/4P3/2N2NP1/PPPP1P1P/R1BQ1RK1 w - - 0 1",
              &fianchetto_no_bishop);
